...
<head>
  ...
  <script>
      ...
      if (passed) {
        ...
        quizContainer.innerHTML = `
          <div align="center">
            ...
            <button class="btn btn-primary" onclick="goBackToHome()">Back to Educator Home</button>
          </div>
        `;
      }
    }
    ...
    function goBackToHome() {
      window.location.href = "educatorhome.jsp"; // Replace with the actual URL of the Citizen Home page
    }
  </script>
</head>
<body>
