...
<div class="navbar">
    ...
    <a href="legalexperthome.jsp" class="${page == 'legalExpert' ? 'active' : ''}">Legal Expert</a>
    <a href="educatorRegistration.jsp" class="${page == 'legalExpert' ? 'active' : ''}">Educator</a>
    <a href="educatorlogin.jsp" class="${page == 'legalExpert' ? 'active' : ''}">Educator Login</a>
